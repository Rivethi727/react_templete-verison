...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
      <img src={require("./assets/img/hero-img.png")} class="img-fluid" alt=""/>
    </div>
  </div>
</div>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row">
      ...
      <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
        <div class="box">
          <img src={require("./assets/img/values-1.png")} class="img-fluid" alt=""/>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
        <div class="box">
          <img src={require("./assets/img/values-2.png" )}class="img-fluid" alt=""/>
      ...
      <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
        <div class="box">
          <img src={require("./assets/img/values-3.png")} class="img-fluid" alt=""/>
    ...
    <div class="row feature-icons" data-aos="fade-up">
      ...
      <div class="row">
        ...
        <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
          <img src={require("./assets/img/features-3.png")} class="img-fluid p-4" alt=""/>
        </div>
    ...
    <div class="row gy-4" data-aos="fade-left">
      ...
      <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="100">
        <div class="box">
          ...
          <img src={require("./assets/img/pricing-free.png")} class="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
      ...
      <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="200">
        <div class="box">
          ...
          <img src={require("./assets/img/pricing-starter.png")} class="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
      ...
      <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="300">
        <div class="box">
          ...
          <img src={require("./assets/img/pricing-business.png")} class="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
      ...
      <div class="col-lg-3 col-md-6" data-aos="zoom-in" data-aos-delay="400">
        <div class="box">
          ...
          <img src={require("./assets/img/pricing-ultimate.png")} class="img-fluid" alt=""/>
          <ul>
            <li>Aida dere</li>
            <li>Nec feugiat nisl</li>
            <li>Nulla at volutpat dola</li>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="clients-slider swiper">
      <div class="swiper-wrapper align-items-center">
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-1.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-2.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-3.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-4.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-5.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-6.png")} class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-7.png" )}class="img-fluid" alt=""/></div>
        <div class="swiper-slide"><img src={require("./assets/img/clients/client-8.png")} class="img-fluid" alt=""/></div>
      </div>
      <div class="swiper-pagination"></div>
    </div>
  </div>
